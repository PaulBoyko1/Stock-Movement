...
The first executable research baseline compares monthly momentum allocation across 12 historical industry portfolios with an equal-weight industry benchmark. These are reconstructed research portfolios, not a tradable ETF implementation. Application UI, earnings models and automated execution remain proposed work.
